  ...
  return (
    <Container>
      ...
      {isRunConfirmOpen ? (
        <ConfirmOverlay>
          <ConfirmDialog>
            <ConfirmCloseButton onClick={() => setIsRunConfirmOpen(false)}>
              ×
            </ConfirmCloseButton>
            ...
            <ConfirmActions>
              <ConfirmCancelButton onClick={() => setIsRunConfirmOpen(false)}>
                취소
              </ConfirmCancelButton>
              <ConfirmSaveRunButton onClick={handleSaveAndRun}>
                저장 후 실행
              </ConfirmSaveRunButton>
            </ConfirmActions>
          </ConfirmDialog>
        </ConfirmOverlay>
      ) : null}
...
const ConfirmSaveRunButton = styled.button`
  min-width: 140px;
  height: 44px;
  border: none;
  border-radius: 12px;
